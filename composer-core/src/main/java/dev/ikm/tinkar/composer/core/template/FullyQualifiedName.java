...
import static dev.ikm.tinkar.composer.core.ChronologyBuilder.createPublicId;
...
public class FullyQualifiedName extends SemanticTemplate {
    ...
    protected List<Field> assignFieldValues() {
        ...
        PublicId descriptionType = createPublicId(TinkarTerm.FULLY_QUALIFIED_NAME_DESCRIPTION_TYPE);
