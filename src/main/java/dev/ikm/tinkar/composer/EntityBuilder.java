...
public class EntityBuilder {
	...
	private static final EntityToTinkarSchemaTransformer transformer = EntityToTinkarSchemaTransformer.getInstance();
	...
	public static ConceptEntity buildConceptEntity(Concept concept, PublicId stampId) {
	...
	public static PatternEntity buildPatternEntity(Pattern pattern, PublicId stampId,
	...
	public static SemanticEntity buildSemanticEntity(Semantic semantic, PublicId stampId, EntityProxy referencedComponent,
													 Pattern pattern, ImmutableList<Object> fieldValues) {
	...
	public static StampEntity buildStampEntity(UUID id, State state, long time, PublicId authorId, PublicId moduleId,
											   PublicId pathId) {
		return StampRecord.make(id, state, time, authorId, moduleId, pathId);
	}
