...
public class ComposeConceptIT {
	...
	public static final File packageOutput = createFilePathInTarget.apply("package.zip");
	...
	public void createConceptWithPublicIdTest() throws Exception {
		try (Composer composer = new Composer(packageOutput.toPath())) {
			...
			session.compose((ConceptAssembler conceptAssembler) -> conceptAssembler.concept(conceptProxy));
		} catch (Exception e) {
